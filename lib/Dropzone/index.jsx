...
export class Dropzone extends Component {
	...
	render() {
		...
		const { className, classes: classesProp, padded, types, extensions, children, disabled } = this.props;
